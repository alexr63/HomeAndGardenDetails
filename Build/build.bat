...
set project= "C:\Home\Cowrie\selectedhot.local\DesktopModules\HomeAndGardenDetails"
set rootPath="C:\Home\Cowrie\selectedhot.local\Bin"
set package= "C:\Temp\HomeAndGardenDetails"
...
cd %package%
"C:\Program Files\7-Zip\7z" a -tzip HomeAndGardenDetails.zip *.*
